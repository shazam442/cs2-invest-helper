...
class SkinportAPIService < BaseSkinportService
  def sync_skinport_items_to_file
    return false if not ApiRequest.five_minutes_passed_since_last_skinport_request?
    ...
    data = JSON.parse(skinport_response.body)
